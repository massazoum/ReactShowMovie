...
const Footer = () => {
 const isopen = useSelector((state)=>state.MoviePop.isOpenPop)
  ...
  return ( <div>
    {!isopen && ( <footer className="bg-primary text-light py-4">  <div className="container">
        <div className="row">
          <div className="col-lg-6">
            <h5>About</h5>
            <p> Welcome to our movie site! We are dedicated to providing you with the latest and greatest movies
       ...
       &copy; {new Date().getFullYear()} MassaZoum. All rights reserved.
     </div></footer> )} 
   </div>
  );
};
